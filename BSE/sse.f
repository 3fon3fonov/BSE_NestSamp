...
*    log10(Teff), core mass, epoch, spin and renv.
*
      OPEN(23,file='evolve.dat',status='unknown')
c      text1 = ' Tev(Myr)    type      Mo        Mt      log10(L) '
c      text2 = ' log10(R) log10(Teff)  Mc        Menv       Renv' 
c      text3 = ' epoch      spin  ' 
      text1 = '    Tev(Myr)       type        Mo          Mt       '
      text2 = ' L          R       Teff          Mc          Menv'
      text3 = '            Renv            epoch    spin   '    
 ...
 30   j = j + 1
      ...
      WRITE(23,99)(scm(j,k),k=1,10),scm(j,12),scm(j,13)
      if(scm(j,1).ge.0.0) goto 30
      CLOSE(23)
 99   FORMAT(9f12.4,2p,e12.4,0p,f12.4,1p,e12.4)
*
