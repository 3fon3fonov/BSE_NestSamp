...
*
c     OPEN(22,file='binary.in', status='old')
      READ(*,55) outfile
55    format (a)
      READ(*,*)mass0(1),mass0(2),tphysf,tb,kstar(1),kstar(2),z,ecc
      READ(*,*)neta,bwind,hewind,alpha1,lambda
      READ(*,*)ceflag,tflag,ifflag,wdflag,bhflag,nsflag,mxns,idum
      READ(*,*)pts1,pts2,pts3
      READ(*,*)sigma,beta,xi,acc2,epsnov,eddfac,gamma
...
*
 ...
 30   j = j + 1
     ...
     &            bcm(j,14),bcm(j,28),bcm(j,30),
     &            bcm(j,31),bcm(j,32),bcm(j,7),bcm(j,21)
      if(bcm(j,1).ge.0.0) goto 30
      CLOSE(23)
* 99   FORMAT(f10.4,2i3,10f10.4,6e12.4,f7.3,2e12.4)
 99   FORMAT(f10.4,2i3,10f10.4,6e12.4,f10.5,2e12.4)
 999  FORMAT(f10.4,2f10.4,1p,2e12.4)

* 99   FORMAT(f10.4,2i3,10f10.4,5f12.4,1f12.4,f10.5,2f12.4)
* 999  FORMAT(f10.4,2f10.4,1p,2f12.4)
